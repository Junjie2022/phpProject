...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Bulletin Board - Student Score Management System</title>
        ...
        <div id="sidebar">
            ...
            <div class="sidebar-inner">
                ...
                <ul id="sideNav" class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="profile.php">Person Information<i class="im-profile"></i></a>
                    </li>
                                    ...
                                    <table class="table display" id="datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="per15">Release Time</th>
