...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Edit Course info - Student Achievement Management System</title>
            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12 heading">
                        <h1 class="page-header"><i class="im-book"></i>Course Management</h1>
                        <!-- Start .bredcrumb -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal" role="form" method="post" action="update_course.php">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-2 col-sm-12 control-label">Semester</label>
                                    <div class="col-lg-10 col-md-10">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-2 col-sm-12 control-label">Credit Hours</label>
                                    <div class="col-lg-10 col-md-10">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-2 col-sm-12 control-label">Credit Points</label>
                                    <div class="col-lg-10 col-md-10">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-2 col-sm-12 control-label">Teacher</label>
                                    <div class="col-lg-10 col-md-10">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">
                                                ...
                                                <span class="help-block">Choose one teacher</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-2 col-sm-12 control-label">Course Selection</label>
                                    <label class="radio-inline">
                                        <input type="radio" name="if" value="1" checked="checked">Available
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="if" value="0">Unavailable
                                    </label>
                                </div>
