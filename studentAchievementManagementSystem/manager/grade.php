...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Grade Entry - Student Achievement Management System</title>
            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12 heading">
                        <h1 class="page-header"><i class="en-login"></i>Entering Grades</h1>
                        <!-- Start .bredcrumb -->
...
<!--                                    </a>-->
                        ...
                        if(isset($_GET['success'])) {
                            echo "<div class=\"alert alert-success fade in\">
                                ...
                                <strong>Success!</strong> Enter the grade successfully!
                            </div>";
                        }
                        ?>
                    </div>
                                ...
                                echo "<table class=\"table display\" id=\"datatable1\">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class=\"per13\">Student ID</th>
                                            <th class=\"per13\">Phone</th>
                                            <th class=\"per12\">Work Email</th>
                                            <th class=\"per9\">Class Number</th>
                                            <th class=\"per15\">Major</th>
                                    ...
                                    <div class="col-lg-10 col-md-10">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">
                                                ...
                                                <span class="help-block">Choose one student</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!--                                    <label class="radio-inline">-->
<!--                                        <input type="radio" name="score_type" value="Repeat">Repeat-->
<!--                                    </label>-->
                                </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#datatable'+i).dataTable({
                    ...
                    "oLanguage": {
                        "sSearch": "",
                        "sLengthMenu": "<span>Show_MENU_ Results</span>"
                    },
                    "bJQueryUI": false,
                    "bAutoWidth": false,
