...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Achievement - Student Achievement Management System</title>
            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12 heading">
                        <h1 class="page-header"><i class="ec-archive2"></i>Grade Management </h1>
                        <!-- Start .bredcrumb -->
...
<!--                                    </a>-->
                        ...
                        if(isset($_GET['success'])) {
                            echo "<div class=\"alert alert-success fade in\">
                                ...
                                <strong>Success!</strong> Edit grade successfully!
                            </div>";
                        }
                        ?>
                    </div>
                            ...
                            while($row=mysqli_fetch_array($result)){
                                ...
                                echo "<table class=\"table display\" id=\"datatable1\">
                                    <thead>
                                        <tr>
                                            <th class=\"per5\">#</th>
                                            <th class=\"per5\">Avatar</th>
                                            <th class=\"per5\">Name</th>
                                            <th class=\"per10\">Student ID</th>
                                            <th class=\"per8\">Class ID</th>
                                            <th class=\"per12\">Major</th>
                                            <th class=\"per12\">Campus</th>
                                            <th class=\"per5\">Grade</th>
                                            <th class=\"per5\">Grade Point</th>
                                            <th class=\"per10\">Grade Type</th>
                                            <th class=\"per10\">Input Time</th>
                                            <th class=\"per7\">Recorded By</th>
                                            <th class=\"per6\">Edit</th>
                                        </tr>
                                    </thead>
                                    <tbody>";
                                $i=1;
                                while($row2=mysqli_fetch_array($result2)){
                                    ...
                                    echo "<td><button class='btn btn-xs btn-primary' onclick=\"window.location.href='update_grade.php?id=".$row2['id']."'\">Edit</button></td>";
                                    echo "</tr>";
                                    $i++;
                                }
                                echo "</tbody>
