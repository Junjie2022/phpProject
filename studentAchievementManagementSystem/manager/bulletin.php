...
if(isset($_POST['submit'])){
    ...
    if($content==""){$error="Please enter content！";}else{
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Bulletin Board - Student Achievement Management System</title>
...
<!--                            <i class="im-windows8 text-logo-element animated bounceIn"></i><span class="text-logo">StudentManagement</span><span class="text-slogan">Management</span>-->
            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12 heading">
                        <h1 class="page-header"><i class="im-bullhorn"></i>Bulletin</h1>
                        <!-- Start .bredcrumb -->
                        ...
                        if(isset($_GET['success'])) {
                            if($_GET['success']=="1"){
                                echo "<div class=\"alert alert-success fade in\">
                                    ...
                                    <strong>Success!</strong> Successfully added a bulletin.
                                </div>";
                            }elseif($_GET['success']=="del"){
                                echo "<div class=\"alert alert-success fade in\">
                                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>
                                    <i class=\"fa-ok alert-icon s24\"></i>
                                    <strong>Success!</strong> Successfully deleted a bulletin.
                                </div>";
                            }
                        }
                        ?>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="panel panel-default plain toggle panelClose">
                                ...
                                <div class="panel-heading white-bg">
                                    <h4 class="panel-title">Bulletin</h4>
                                </div>
                                <div class="panel-body">
                                    <table class="table display" id="datatable">
                                        <thead>
                                            <tr>
                                                <th class="per5">#</th>
                                                <th class="per10">Author</th>
                                                <th class="per15">Publish Time</th>
                                                <th class="per60">Content </th>
                                                <th class="per15 text-right">Delete</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            while($row=mysqli_fetch_array($result)){
                                                ...
                                                echo "<td class=\"pull-right\"><button class='btn btn-xs btn-danger' onclick=\"window.location.href='dele_bulletin.php?id=".$row["id"]."'\">Delete</button></td>";
                                                echo "</tr>";
                                                $i++;
                                            }
                                    ...
                                    <form class="form-horizontal" role="form" method="post" action="bulletin.php">
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-12">
                                                ...
                                                <button type="submit" name="submit" class="btn btn-success btn-xs pull-right">Submit</button>
                                            </div>
                                        </div>
                                        <!-- End .form-group  -->
                                    </form>
