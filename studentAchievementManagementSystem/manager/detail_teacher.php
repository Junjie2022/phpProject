...
if(isset($_GET['id'])){
    ...
    $query = "SELECT t.name, teacher_no, avatar, academic_title, dob, gender, personalEmail, workEmail, phone, inauguration_date, leave_date, a.name AS aname, address, username FROM teacher t INNER JOIN academy a ON a.id = t.academy_id WHERE t.id = $id";
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "UPDATE teacher SET dob = '$dob', phone = '$phone', workEmail = '$workEmail', personalEmail= '$personalEmail', username = '$username' WHERE id = $id";
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Teacher Information - Student Achievement Management System</title>
            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12 heading">
                        <h1 class="page-header"><i class="im-profile"></i>Teacher Information</h1>
                        <!-- Start .bredcrumb -->
...
<!--                                    </a>-->
                        ...
                        if(isset($_GET['success'])) {
                            echo "<div class=\"alert alert-success fade in\">
                                ...
                                <strong>Success!</strong> Successfully edited teacher information.
                            </div>";
                        }
                        ?>
                    </div>
                            ...
                            <div class="panel panel-default plain profile-widget">
                                ...
                                <div class="panel-body">
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="profile-avatar">
                                            <img class="img-responsive" src="../assets/img/avatars/<?php echo $ttname['avatar'];?>" alt="User Photo">
                                        </div>
                                    </div>
                                    <div class="col-lg-8 col-md-8 col-sm-12">
                                        <div class="profile-name">
                                            <?php echo $ttname['name'];?> <span class="label label-success">Teacher</span>
                                        </div>
                                        <div class="profile-quote">
                                            <p>Education is a great endeavor!</p>
                                ...
                                <div class="panel-footer white-bg">
                                    <ul class="profile-info">
                                        ...
                                        <li><?php if($ttname['gender']=="male"){echo " <i class=\"fa-male\"></i>&ensp;male";}else{echo " <i class=\"fa-female\"></i>&ensp;female";}?></li>
                                        <li><i class="im-point-right"></i><abbr title="Teacher ID"><?php echo $ttname['teacher_no'];?></abbr></li>
                                        <li><i class="fa-bitbucket"></i> <abbr title="Title"><?php echo $ttname['academic_title'];?></abbr></li>
                                        <li><i class="im-home3"></i><abbr title="Campus"><?php echo $ttname['aname'];?></abbr></li>
                                        <li><i class="im-office"></i><abbr title="Address"><?php echo $ttname['address'];?></abbr></li>
                                        <li><i class="fa-time"></i> <abbr title="Inauguration Date"><?php echo $ttname['inauguration_date'];?></abbr></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- End .panel -->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="panel panel-default plain">
                                ...
                                <div class="panel-heading white-bg">
                                    <h4 class="panel-title"><i class="ec-user"></i>Edit Information</h4>
                                </div>
                                <div class="panel-body">
                                    <form class="form-vertical hover-stripped" role="form" method="post" action="detail_teacher.php?id=<?php echo $id;?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" name="workEmail" value="<?php echo $ttname['workEmail'];?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">PersonalEmail</label>
                                            <input type="text" class="form-control" name="personalEmail" value="<?php echo $ttname['personalEmail'];?>">
                                        </div>
                                        <div class="form-group">
