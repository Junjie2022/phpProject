...
// pic1
$query = "SELECT COUNT(id) AS nums FROM student WHERE gender = 'male'";
$result3 = mysqli_query($connection, $query);
$res = mysqli_fetch_array($result3);
$student_m = (int)$res['nums'];
if($student_m==null){$student_m=0;}
mysqli_free_result($result3);
$query = "SELECT COUNT(id) AS nums FROM student WHERE gender = 'female'";
$result3 = mysqli_query($connection, $query);
$res = mysqli_fetch_array($result3);
...
// 图 2
$query = "SELECT COUNT(id) AS nums FROM teacher WHERE gender = 'male'";
$result3 = mysqli_query($connection, $query);
$res = mysqli_fetch_array($result3);
$teacher_m = (int)$res['nums'];
if($teacher_m==null){$teacher_m=0;}
mysqli_free_result($result3);
$query = "SELECT COUNT(id) AS nums FROM teacher WHERE gender = 'female'";
$result3 = mysqli_query($connection, $query);
$res = mysqli_fetch_array($result3);
...
<!--                            <i class="im-windows8 text-logo-element animated bounceIn"></i><span class="text-logo">StudentManagement</span>-->
        ...
        <div id="sidebar">
            ...
            <div class="sidebar-inner">
                ...
                <ul id="sideNav" class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="grade.php"><i class="en-login"></i>Login</a>
                    </li>
...
<!--                                    </a>-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="panel panel-info">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title"><i class="fa-list"></i>Number of students by date of birth</h4>
                                </div>
                                <div class="panel-body">
                                    <div class="page-header text-right">
                                        <h3>Total Students: <?php echo $student_to;?></h3>
                                    </div>
                                    <form action="home.php" class="form-horizontal">
                                        ...
                                        for($i=0;$i<6;$i++){
                                            ...
                                            echo "<div class=\"form-group\">
                                                    <label class=\"col-lg-2 control-label\">".$year." Year </label>
                                                    <div class=\"col-lg-10\">
                                                        <div class=\"progress\">
        ...
        $(document).ready(function() {
            ...
            $(function () {
                ...
                var data = [
                    { label: 'male',  data: <?php echo $student_m;?>, color: colours.blue},
                    { label: 'female',  data: <?php echo $student_f;?>, color: colours.red}
                ];
            ...
            $(function () {
                ...
                var data = [
                    { label: 'Male',  data: <?php echo $teacher_m;?>, color: colours.blue},
                    { label: 'Female',  data: <?php echo $teacher_f;?>, color: colours.red}
                ];
