                    ...
                    <div class="col-lg-12 heading">
                        ...
                        if(isset($_GET['success'])) {
                            echo "<div class=\"alert alert-success fade in\">
                                ...
                                <strong>success!</strong> Successfully modified a student's grade.
                            </div>";
                        }
                        ?>
                    </div>
                                ...
                                echo "<table class=\"table display\" id=\"datatable1\">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class=\"per10\">StudentID</th>
                                            <th class=\"per8\">classID</th>
                                            <th class=\"per12\">program</th>
                                            <th class=\"per12\">campus</th>
                                            <th class=\"per5\">grade</th>
                                            <th class=\"per5\">Grade point</th>
                                            <th class=\"per10\">score type</th>
                                            <th class=\"per10\">storage time</th>
                                            <th class=\"per7\">Entry person</th>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#datatable'+i).dataTable({
                    ...
                    "oLanguage": {
                        "sSearch": "",
                        "sLengthMenu": "<span>disply _MENU_ result</span>"
                    },
                    "bJQueryUI": false,
                    "bAutoWidth": false,
