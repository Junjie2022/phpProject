...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>bulletin - Student Achievement Management System</title>
                        ...
                        if(isset($_GET['success'])) {
                            if($_GET['success']=="1"){
                                echo "<div class=\"alert alert-success fade in\">
                                    ...
                                    <strong>success!</strong> An announcement was successfully added。
                                </div>";
                            }elseif($_GET['success']=="del"){
                                echo "<div class=\"alert alert-success fade in\">
                                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>
                                    <i class=\"fa-ok alert-icon s24\"></i>
                                    <strong>success!</strong> Successfully deleted an announcement。
                                </div>";
                            }
                        }
                        ?>
                                ...
                                <div class="panel-body">
                                    <table class="table display" id="datatable">
                                        <thead>
                                            <tr>
                                                <th class="per5">#</th>
                                                <th class="per10">announcer</th>
                                                <th class="per15">announce time</th>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="panel panel-default toggle panelClose">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">announce</h4>
                                </div>
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form" method="post" action="bulletin.php">
                                        <div class="form-group">
