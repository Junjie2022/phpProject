                                ...
                                <div class="panel panel-default plain toggle panelClose">
                                    ...
                                    <div class="panel-body">
                                        <table class="table display" id="datatable">
                                            <?php
                                            if($option=="course"){
                                                echo "<p class='text-primary'>About <b>course</b> search result.</p>";
                                                echo "<thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>courseID</th>
                                                ...
                                                echo "<p class='text-primary'>about <b>teacher</b> search results</p>";
                                                echo "<thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Avatar</th>
                                                ...
                                                echo "<p class='text-primary'>Search results will appear below.</p>";
                                            }
                                            echo "</tbody>";
                                            ?>
                                        </table>
