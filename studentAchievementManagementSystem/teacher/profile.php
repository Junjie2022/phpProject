                        ...
                        if(isset($_GET['success'])) {
                            if($_GET['success']=="1"){
                                echo "<div class=\"alert alert-success fade in\">
                                    ...
                                    <strong>Done！</strong> Personal information modified successfully.
                                </div>";
                                ...
                                echo "<div class=\"alert alert-success fade in\">
                                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>
                                    <i class=\"fa-ok alert-icon s24\"></i>
                                    <strong>Success!</strong> Successfully modified image.
                                </div>";
                            }
                        }
                        ?>
                            ...
                            <div class="panel panel-default plain profile-widget">
                                ...
                                <div class="panel-body">
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="profile-avatar">
                                            <a  href="#avatar" data-toggle="modal" title="Edit Avatar"><img class="img-responsive" src="../assets/img/avatars/<?php echo $tname['avatar'];?>" alt="avatar"></a>
                                        </div>
                                        <!-- Modal itself -->
                                ...
                                <div class="panel-footer white-bg">
                                    <ul class="profile-info">
                                        ...
                                        <li><i class="fa-time"></i> <abbr title="inauguration data"><?php echo $tname['inauguration_date'];?></abbr></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- End .panel -->
