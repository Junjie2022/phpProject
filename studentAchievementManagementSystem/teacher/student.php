        ...
        <div id="sidebar">
            ...
            <div class="sidebar-inner">
                ...
                <ul id="sideNav" class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="bulletin.php">Bullletin<i class="im-bullhorn"></i></a>
                    </li>
                    ...
                    <!--<li><a href="search.php"><i class="st-search"></i>seach</a>
                    </li>-->
                    <li><a href="../logout.php"><i class="im-exit"></i>Logout</a>
                    </li>
                </ul>
            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12 heading">
                        <h1 class="page-header"><i class="im-accessibility"></i>Student</h1>
                        <!-- Start .bredcrumb -->
                        ...
                        if(isset($_GET['success'])) {
                            if($_GET['success']=="1"){
                                echo "<div class=\"alert alert-success fade in\">
                                    ...
                                    <strong>Success!</strong> Successfully added a student.
                                </div>";
                            }elseif($_GET['success']=="del"){
                                echo "<div class=\"alert alert-success fade in\">
                                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>
                                    <i class=\"fa-ok alert-icon s24\"></i>
                                    <strong>Success!</strong> Successfully deleted a student.
                                </div>";
                            }elseif($_GET['success']=="2"){
                                echo "<div class=\"alert alert-danger fade in\">
                                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>
                                    <i class=\"fa-remove alert-icon s24\"></i>
                                    <strong>Error!</strong> This student cannot be deleted. Reason: The student has been entered into other information.
                                </div>";
                            }
                        }
                        ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal" role="form" method="post" action="student.php">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-2 col-sm-12 control-label">Date Of Birth</label>
                                    <div class="col-lg-10 col-md-10">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">
                                    ...
                                    <div class="col-lg-10 col-md-10">
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3">
                                                <input type="text" class="form-control" placeholder="personalEmail" name="personalEmail">
                                            </div>
                                            <div class="col-lg-3 col-md-3">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-2 col-sm-12 control-label">Enrolment Date</label>
                                    <div class="col-lg-10 col-md-10">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">
                                                <div class="input-group">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-2 col-sm-12 control-label">Class</label>
                                    <div class="col-lg-10 col-md-10">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">
