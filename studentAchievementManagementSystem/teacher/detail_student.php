        ...
        <div id="sidebar">
            ...
            <div class="sidebar-inner">
                ...
                <ul id="sideNav" class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="student.php">Student Management<i class="im-accessibility"></i></a>
                    </li>
                    <li><a href="grade_manage.php">Grade Management<i class="ec-archive2"></i></a>
                    </li>
                    ...
                    <div class="col-lg-12 heading">
                        ...
                        <div class="option-buttons">
                            <div class="btn-toolbar" role="toolbar">
                                <div class="btn-group">
                                    <a id="clear-localstorage" class="btn tip" title="refrseh">
                                        ...
                                        <div class="option-dropdown">
                                            <div class="row">
                                                ...
                                                <form class="form-horizontal" role="form" method="post" action="bulletin.php">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-lg-12">
                                                            <button class="btn btn-success btn-xs pull-right" type="submit" name="submit">Annouce</button>
                                                        </div>
                                                    </div>
                                                    <!-- End .form-group  -->
                                                </form>
                        ...
                        if(isset($_GET['success'])) {
                            echo "<div class=\"alert alert-success fade in\">
                                ...
                                <strong>Success!</strong> Successfully added a student's information.
                            </div>";
                        }
                        ?>
                    </div>
                            ...
                            <div class="panel panel-default plain profile-widget">
                                ...
                                <div class="panel-body">
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="profile-avatar">
                                            <img class="img-responsive" src="../assets/img/avatars/<?php echo $sname['avatar'];?>" alt="user image">
                                        </div>
                                    </div>
                                ...
                                <div class="panel-footer white-bg">
                                    <ul class="profile-info">
                                        ...
                                        <li><i class="im-home3"></i><abbr title="Class ID"><?php echo $sname['class_no'];?></abbr></li>
                                        <li><i class="fa-bitbucket"></i> <abbr title="Program"><?php echo $sname['mname'];?></abbr></li>
                                        <li><i class="im-office"></i><abbr title="Campus"><?php echo $sname['aname'];?></abbr></li>
                                        <li><i class="fa-time"></i> <abbr title="date"><?php echo $sname['enrolment'];?></abbr></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- End .panel -->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="panel panel-default plain">
                                ...
                                <div class="panel-heading white-bg">
                                    <h4 class="panel-title"><i class="ec-user"></i>Modify information</h4>
                                </div>
                                <div class="panel-body">
                            ...
                            <div class="panel panel-default plain">
                                <!-- Start .panel -->
                                <div class="panel-heading white-bg">
                                    <h4 class="panel-title">Student's Course</h4>
                                </div>
                                <div class="panel-body">
