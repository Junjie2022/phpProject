            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12 heading">
                        <h1 class="page-header"><i class="en-login"></i>Grade</h1>
                        <!-- Start .bredcrumb -->
                        ...
                        if(isset($_GET['success'])) {
                            echo "<div class=\"alert alert-success fade in\">
                                ...
                                <strong>Success！</strong> Successfully entered grades for this student.
                            </div>";
                        }
                        ?>
                    </div>
                    ...
                    <div class="row">
                            ...
                            while($row=mysqli_fetch_array($result)){
                                ...
                                echo "<table class=\"table display\" id=\"datatable1\">
                                    <thead>
                                        <tr>
                                            <th class=\"per5\">#</th>
                                            <th class=\"per11\">avatar</th>
                                            <th class=\"per7\">name </th>
                                            <th class=\"per13\">studentID</th>
                                            <th class=\"per13\">phone</th>
                                            <th class=\"per12\">email</th>
                                            <th class=\"per9\">classID</th>
                                            <th class=\"per15\">program</th>
                                            <th class=\"per15\">campus</th>
                                        </tr>
                                    </thead>
                                    <tbody>";
                                $i=1;
                                ...
                                while($row2=mysqli_fetch_array($result2)){
                                    ...
                                    if($row2['phone']==""||$row2['phone']==null){$row2['phone']="none";}
                                    echo "<td>".$row2['phone']."</td>";
                                    if($row2['workEmail']==""||$row2['workEmail']==null){$row2['workEmail']="none";}
                                    echo "<td>".$row2['workEmail']."</td>";
                        ...
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal" role="form" method="post" action="grade.php">
                                    ...
                                    <div class="col-lg-10 col-md-10">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">
                                                ...
                                                <span class="help-block">Choose a student</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-2 col-sm-12 control-label">Grade Type</label>
                                    <label class="radio-inline">
                                        <input type="radio" name="score_type" value="pass" checked="checked">pass
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="score_type" value="retake">retake
                                    </label>
<!--                                    <label class="radio-inline">-->
<!--                                        <input type="radio" name="score_type" value="重修">Retake-->
<!--                                    </label>-->
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10 col-md-10">
                                        <button onclick='test()' class="btn btn-primary" type="submit" name="submit">Submit</button>
                                    </div>
                                </div><br><br>
                            </form>
                        </div>
